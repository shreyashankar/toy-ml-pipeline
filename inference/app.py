...
prediction_histogram = Histogram(
    ...
    "Histogram of prediction outputs",
...
@register(
    ...
    inputs=[model_path],
    input_vars=["feature_path", "row_idx"],
    output_vars=["output_ids"],
    endpoint=True,
)
def predict():
    ...
    result = {"prediction": df["prediction"].to_list()}
...
if __name__ == "__main__":
    ...
    create_component(
        "inference",
        "API that does inference on a group of features.",
        "shreya",
    )
